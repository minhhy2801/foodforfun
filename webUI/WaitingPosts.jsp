<%-- 
    Document   : WaitingPosts
    Created on : Nov 10, 2017, 11:41:53 AM
    Author     : Dell
--%>
                    ...
                    <div class="page-title">
                        <div class="page-breadcrumb">
                            <ol class="breadcrumb">
                                ...
                                <li class="active">Waiting Posts</li>
                            </ol>
                        </div>
                    </div>
                    <div id="main-wrapper">
                        <div class="col-md-12">
                            <div class="panel panel-white">
                                <div class="panel-heading clearfix">
                                    <h4 class="panel-title">Waiting Posts</h4>
                                </div>
                                <div class="panel-body">
                                    <div class="header-link">
                                        <a href="MainController?action=AllPost&PageID=1">All Post</a> |
                                        <a href="MainController?action=PendPost&PageID=1" class="active">Waiting Accept</a> |
                                        ...
                                        <table id="example" class="display table dataTable" style="width: 100%;" role="grid" aria-describedby="example_info">
                                            ...
                                            <minhhy:forEach var="dto" varStatus="counter" items="${requestScope.AP}">
                                                <tr>
                                                    ...
                                                    <td>${timePublic}</td>
                                                    <td>
                                                        <span class="label label-warning">${dto.status}</span>
                                                    </td>
                                                </tr>
                                            </minhhy:forEach>
                                        </tbody>
                                    ...
                                    <div class="row">
                                        <form action="MainController" method="POST">
                                            ...
                                            <input type="hidden" name="namePage" value="WaitPost"/>
