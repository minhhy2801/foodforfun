<%-- 
    Document   : AllPost
    Created on : Nov 10, 2017, 11:31:31 AM
    Author     : Dell
--%>
                                ...
                                <div class="panel-body">
                                    <div class="header-link">
                                        ...
                                        <div class="table-responsive" style="height: 350px;">
                                            <table id="example" class="display table dataTable" style="width: 100%;" role="grid" aria-describedby="example_info">
                                                ...
                                                <tbody>
                                                <minhhy:forEach var="dto" varStatus="counter" items="${requestScope.APs}">
                                                    <tr>
                                                        <td>
                                                        ...
                                                        <td>
                                                            ...
                                                            <minhhy:if test="${dto.status eq 'Pending'}">
                                                                <span class="label label-warning">${dto.status}</span>
                                                            </minhhy:if>
                                                            <minhhy:if test="${dto.status eq 'Ban'}">
                                    ...
                                    <div class="row">
                                        <form action="MainController" method="POST">
                                            ...
                                            <input type="hidden" name="namePage" value="AllPost"/>
