    ...
    <head>
        ...
        <script>
            function showEdit(id, name, des) {
                ...
                var addTags = document.getElementById("addCates");
                ...
                <div class="page-sidebar-inner slimscroll">
                    <minhdn:if test="${ROLE eq 'Editor'}">
                        <ul class="menu accordion-menu">
                            ...
                            <li class="active"><a href="LoadAddCateController?PageID=1" class="waves-effect waves-button"><span class="menu-icon icon-grid"></span><p>Categories</p><span class="active-page"></span></a></li>
                ...
                <div id="main-wrapper">
                    <div class="row">
                        <minhdn:if test="${empty FAULTVALUE}">
                            <div class="col-md-6" id="addCates" style="display: block">
                                <div class="panel panel-white">
                                    ...
                                    <div class="panel-body">
                                        <div class="center">
                                            <form id="addtag" method="post" class="validate" action="AddCateController">
                                                <font color="red">${FAULTADD}</font><br/>
                                                <label class="text-uppercase">Name: </label>
                                                <input type="text" class="form-control" name="txtCateName" value="${FAULTADDVALUE.name}">
                                                ...
                                                <button type="submit" class="btn btn-facebook float-left">Add Category</button>
                                            </form>
                                        </div>
                                    </div>
                                </div>
                        ...
                        <minhdn:if test="${not empty FAULTVALUE}">
                            <div class="col-md-6" id="addCates" style="display: none">
                                <div class="panel panel-white">
                                    <div class="panel-heading clearfix">
                                        <h3 class="panel-title">Add Category</h3>
                                    </div>
                                ...
                                <div class="panel panel-white">
                                    ...
                                    <div class="panel-body">
                                        <div class="center">
                                            ...
                                            <form id="addtag" method="post" class="validate" action="UpdateCateController">
                                                <input type="text" id="idAdd" name="txtIDUpdate"/>
                                                <label class="text-uppercase">Name: </label>
                                                <input type="text" class="form-control" id="updateName" name="txtCateName">
                                                ...
                                                <button type="submit" class="btn btn-facebook float-left">Update Category</button>
                                            </form>
                                        </div>
                                    </div>
                                </div>
                                    ...
                                    <div class="panel-body">
                                        <div class="center">
                                            <form id="addtag" method="post" class="validate" action="UpdateCateController">
                                                ...
                                                <label class="text-uppercase">Name: </label>
                                                <input type="text" class="form-control" id="updateName" name="txtCateName" value="${FAULTVALUE.name}">
                                                <label class="text-uppercase">Description:</label>
                                ...
                                <div class="panel-body">
                                    <div class="center">
                                        <table id="mytable" class="table table-bordred table-striped">
                                            ...
                                            <tbody>
                                                <minhdn:forEach items="${CATE}" var="cate" varStatus="count">
                                                    <tr>
                                                        <minhdn:url var="article" value="MainController">
                                                            <minhdn:param name="tagID" value="${cate.id}"/>
                                                            <minhdn:param name="flagArticle" value="TagClick"/>
                                                            <minhdn:param name="currentPage" value="0"/>
                                                            <minhdn:param name="action" value="Article"/> 
                                                        </minhdn:url>
                                                        <td><a href="${article}">${cate.name}</a></td>
                                                        <td>${cate.createrName}</td>
                                                        <td>${cate.des}</td>
                                                        <td>${cate.count}</td>
                                                        <td>
                                                            <button onclick="showEdit(${cate.id}, '${cate.name}', '${cate.des}')" class="btn btn-primary btn-xs"><span class="fa fa-pencil"></span></button>
                                                        </td>
                                                        <td>
                                                            <form action="DeleteCateController" method="POST">
                                                                <input type="hidden" value="${cate.id}" name="txtIDRemove"/>
                                    ...
                                    <div class="row">
                                        <form action="MainController" method="POST">
                                            ...
                                            <input type="hidden" name="namePage" value="AddCate"/>
