...
public class ViewAllPostController extends HttpServlet {
    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        try {
            ...
            List<AllPostDTO> nextResult = dao.viewAllPost_AdminPage(page + 1);
            request.setAttribute("NEXTRESULT", nextResult.size());
//      result1 = dao.viewAcceptedPost_AdminPage();
//      request.setAttribute("AP", result1);
            result = dao.viewAllPost_AdminPage(page);
            request.setAttribute("APs", result);
            request.getRequestDispatcher("AllPost.jsp").forward(request, response);
        } catch (Exception e) {
            log("All Post Admin Error: " + e.getMessage());
        }
    }
