 ...
 * @author kubin
 */
public class BlockCommentController extends HttpServlet {
    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        try {
            ...
            if (result == true){
                ...
                request.setAttribute("ERROR", "Can't delete this comment!");
                url = "MainController?action=ArticleDetail&PostID="+ postID; 
            }
        } catch (Exception e) {
            log("ERROR at BlockCommentController " + e.getMessage());
        } finally {
