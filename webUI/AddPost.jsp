<%-- 
    Document   : AddPost
    Created on : Oct 16, 2017, 8:20:06 PM
    Author     : Dell
--%>
...
<html lang="en">
    <head>
        <title>Meteor | Forms - Form Elements</title>
                            ...
                            <div class="col-md-12">
                                <div class="panel panel-white">
                                    <div class="panel-heading clearfix">
                                        ...
                                        <font color="green">${ADDSTATUS}</font>
                                    </div>
                                    <form class="form-horizontal"action="AddpostController" method="POST" id="testform"
                                        ...
                                        <div class="form-group col-sm-6">
                                            ...
                                            <div class="col-sm-12">
                                                ...
                                                <div class="col-md-4">
                                                    <input type="text" class="form-control" placeholder="Add Category..." name="txtNewCate" value="${sessionScope.INPUTCATE}"><br>
                                        ...
                                        <div class="form-group col-sm-6">
                                            ...
                                            <div class="col-sm-12">
                                                ...
                                                <div class="col-md-4">
                                                    <input type="text" class="form-control" placeholder="Add Tags..." name="txtNewTag" value="${sessionScope.INPUTTAG}"><br>
                                                    <font color="red">${sessionScope.TAGEMPTY}</font>
                                                </div>
                                            </div>
                                        </div>
